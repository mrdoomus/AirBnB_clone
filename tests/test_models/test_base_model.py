...
class TestBaseModelDoc(unittest.TestCase):
    '''
    calss to check documentation for BaseModel class
    '''

    @classmethod
    def setUpClass(cls):
        ''' This method run before all test and
            find into BaseModel class all functions.
    ...
    def test_pep8_base_model_class(self):
        ...
        self.assertEqual(result.total_errors, 0,
                         "Found pep8 erros and warnings in base_model.py")
    ...
    def test_pep8_base_model_test(self):
        ...
        self.assertEqual(result.total_errors, 0,
                         "Found pep8 erros and warnings in test_base_model.py")

    def test_module_documentation(self):
        ''' check module documentation '''
        doc = True
        try:
            len(base_model.__doc__) >= 1
        except Exception:
            doc = False
        mesg = "No documentation found for {} module"
        self.assertEqual(
            True, doc, mesg.format(base_model.__name__))

    def test_class_documentation(self):
        ''' check class BaseModel documentation '''
        doc = True
        try:
...
class TestBaseModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.list_objects = [BaseModel, BaseModel,
    ...
    def test_create_object_kwargs(self):
        base = BaseModel(name='name', school='Holberton')
        self.assertTrue(base.name)
    ...
    def test_create_object_simple_storage(self):
        ...
        self.assertEqual(base, dict_obects['BaseModel.' + base.id])
